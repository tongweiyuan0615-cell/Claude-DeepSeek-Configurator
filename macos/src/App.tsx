...
const ACTIVATION_STORAGE_KEY = "deepseek-claude-configurator-macos-activated";
      ...
      <section className="workspace">
        <header className="header">
          <div>
            ...
            <p>输入 DeepSeek API Key 后，自动部署稳定版 Claude Code 并写入 macOS 终端环境配置。</p>
          </div>
        ...
        <section className="panel">
          <div className="section-heading">
            <h2>API Key</h2>
            <span>{activated ? "仅写入本机 macOS 终端配置" : "请先激活软件"}</span>
          </div>
          <label className="field">
